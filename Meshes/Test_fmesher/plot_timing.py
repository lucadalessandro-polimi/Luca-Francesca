...
def plot_timing_data():
    ...
    file_path = os.path.join(os.path.dirname(_file_), 'timing_fmesher.csv')
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("Meshes/Test_fmesher/timing_fmesher.png", dpi=300)

    print("Plot saved as Meshes/Test_mesher/timing_fmesher.png")
