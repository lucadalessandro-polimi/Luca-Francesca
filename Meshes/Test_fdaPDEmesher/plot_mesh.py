...
def plot_dcel(filename):
    ...
    plt.savefig("Meshes/Test_fdaPDEmesher/delaunay_plot.png", dpi=300, bbox_inches='tight', pad_inches=0, transparent=False)
    print("Plot saved as 'Meshes/Test_fdaPDEmesher/delaunay_plot.png'")

if __name__ == "__main__":
    plot_dcel("Meshes/Test_fdaPDEmesher/delaunay_output.json")
